                                ...
                                <div className="row">
                                    <div className="col-md-6">
                                        <div className="form-group mb-3">
                                            ...
                                            <input type="text" className="form-control" {...register("firstName", { required: "This is a required field.", minLength: 3, pattern: /[A-Za-z]{3}/ })} />
                                    ...
                                    <div className="col-md-6">
                                        <div className="form-group mb-3">
                                            ...
                                            <input type="text" className="form-control" {...register('lastName', { required: "This is a required field." })} />
                                    ...
                                    <div className="col-md-6">
                                        <div className="form-group mb-3">
                                            ...
                                            <input type="email" className="form-control" {...register('email', { required: "This is a required field." })} />
                                    ...
                                    <div className="col-md-12">
                                        <div className="form-group mb-3">
                                            ...
                                            <textarea rows="3" {...register('address', { required: "This is a required field." })} className="form-control"></textarea>
                                    ...
                                    <div className="col-md-4">
                                        <div className="form-group mb-3">
                                            <label>City</label>
                                            <input type="text" {...register('city', { required: "This is a required field." })} className="form-control" />
                                            {(errors.city)?.message &&
                                    ...
                                    <div className="col-md-4">
                                        <div className="form-group mb-3">
                                            <label>State</label>
                                            <input type="text" {...register('state', { required: "This is a required field." })} className="form-control" />
                                    ...
                                    <div className="col-md-4">
                                        <div className="form-group mb-3">
                                            ...
                                            <input type="text" {...register('zipcode', { required: "This is a required field." })} className="form-control" />
